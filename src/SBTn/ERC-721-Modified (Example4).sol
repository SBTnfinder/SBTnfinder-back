...
contract SbtN4 is ERC721, ERC721URIStorage, ERC721Enumerable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("SBTn4", "SBTN4") {}
    ...
    function safeMint(address _collectionAddress, uint256 _nftItem) public {
        ...
        string memory uri = "https://gateway.pinata.cloud/ipfs/QmaWiuqqvZVkNevqyR2usUZS7umsETenuEqAZxov5kv3jv";
