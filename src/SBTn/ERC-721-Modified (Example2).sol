...
contract SbtN2 is ERC721, ERC721URIStorage, ERC721Enumerable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("SBTn2", "SBTN2") {}
    ...
    function safeMint(address _collectionAddress, uint256 _nftItem) public {
        ...
        string memory uri = "https://gateway.pinata.cloud/ipfs/QmYH6TaFzV9KKNCLdUxf2bMgYtYjSyuQrKtQuF2wcyjWFa";
