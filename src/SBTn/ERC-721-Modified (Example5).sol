...
contract SbtN5 is ERC721, ERC721URIStorage, ERC721Enumerable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("SBTn5", "SBTN5") {}
    ...
    function safeMint(address _collectionAddress, uint256 _nftItem) public {
        ...
        string memory uri = "https://gateway.pinata.cloud/ipfs/QmetjdsS7U9Tx8chBp15xHsKwgpt2BgFgw6B71VRE7TS3n";
