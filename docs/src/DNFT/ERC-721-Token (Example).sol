...
contract Avatar is ERC721, ERC721URIStorage, KeeperCompatibleInterface {
   ...
   // Metadata information for each stage of the NFT on IPFS.
    ...
    string[] IpfsUri = [
        "https://gateway.pinata.cloud/ipfs/Qme17FYqbmBssrnQTyA4LsAzDfqNo1sL2pt6bJ4Fa2EkQ4",
        "https://gateway.pinata.cloud/ipfs/QmX6u3RSonCYrTofjUyPhMXDpMyLZYyZ4H6wtSc3E5qtbE"
    ]; 
    ...
    constructor(uint _interval) ERC721("Avatar", "AVT") {
        interval = _interval;
